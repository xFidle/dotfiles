return {
  ...
  keys = {
    ...
    { '<leader>fb', function() require('fzf-lua').builtin() end, desc = 'Find builtin fuzzy finder' },

    { '<leader>fw', function() require('fzf-lua').grep_cword() end, desc = 'Find grep current word' },
    ...
    { '<leader><leader>', function() require('fzf-lua').buffers() end, desc = 'Find active buffers' },
